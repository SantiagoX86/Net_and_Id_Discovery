...
* Inference of identity service exposure based on known port-to-service associations.
* Detection of externally reachable identity infrastructure components (e.g., Domain Controllers) through connectivity signals.
...
Identity-related findings generated under this strategy will map to the approved categories defined earlier in this specification. Confidence scoring will reflect the strength of exposure inference based on TCP connectivity (e.g., open port with expected service-port association).
...
No domain may reinterpret or extend the meaning of `service_hint`.
