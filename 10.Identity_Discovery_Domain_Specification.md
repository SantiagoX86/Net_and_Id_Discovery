...
Phase B implementation will prioritize identity-adjacent services that are commonly exposed and safely observable via minimal interaction:

* Kerberos (TCP/88)
* LDAP (TCP/389)
* LDAPS (TCP/636)
* SMB negotiation surface (TCP/445)
* WinRM (TCP/5985)
